        ...
        <div className="mv-title-group d-flex align-items-center">
          <ul className="mv-title-list d-flex align-items-center">
            <li className="mv-title-item">
              <div onClick={handleClickTitle}>Việt Nam</div>
            </li>

            <li className="mv-title-item">
              <div onClick={handleClickTitle}>US-UK</div>
            </li>

            <li className="mv-title-item">
              <div onClick={handleClickTitle}>KPop</div>
            </li>

            <li className="mv-title-item">
              <div onClick={handleClickTitle}>Hòa tấu</div>
            </li>
          </ul>
      ...
      <div className="mv-filter">
        <div className="btn" onClick={() => setIsShowOption(!isShowOption)}>
          ...
          <div className="mv-select d-flex align-items-center">
            ...
            <div className="mv-select-icon">{isShowOption ? <BsChevronUp /> : <BsChevronDown />}</div>
          </div>
        </div>
        <div className="btn" onClick={() => setIsShowOption2(!isShowOption2)}>
          <ul className={`mv-filter-options small ${isShowOption2 ? 'show' : ''}`}>
          ...
          <div className="mv-select d-flex align-items-center">
            ...
            <div className="mv-select-icon">{isShowOption2 ? <BsChevronUp /> : <BsChevronDown />}</div>
          </div>
        </div>
      </div>
